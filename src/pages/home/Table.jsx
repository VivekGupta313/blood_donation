  ...
  function Table({ columns, data }) {
    ...
    return (
      <>
        ...
        <div className=" mb-7  rounded-[4px]  bg-white max-w-[1124px] w-full mx-auto ">
            ...
            headerGroup.headers.map((column) =>
            column.Filter ? (
                  <div className="relative lg:max-w-[410px] w-full" key={column.id}>
        ...
        {/* table */}
        <div className="mt-20 max-w-5xl  mx-auto mt-4 flex flex-col">
